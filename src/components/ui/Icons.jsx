...
const Icon = {
  Wave: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <path d="M7 11.5c1-2 2.5-2 3.5 0s2.5 2 3.5 0 2.5-2 3.5 0"/>
      <path d="M7 17.5c1-2 2.5-2 3.5 0s2.5 2 3.5 0 2.5-2 3.5 0"/>
      <circle cx="12" cy="5" r="2"/><line x1="12" y1="7" x2="12" y2="9"/>
    </svg>
  ),
  Map: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
  ...
  Walk: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
      ...
      <path d="M10.5 8.5L8 19m5.5-7.5l2 4.5m-7-6l3-1 2.5 3.5L17 15"/>
    </svg>
  ),
  Bike: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <circle cx="5.5" cy="17.5" r="3.5"/><circle cx="18.5" cy="17.5" r="3.5"/>
      <path d="M15 6a1 1 0 0 0-1 1v3M11 5L8 17l3.5-4.5 3 1.5"/>
      <polyline points="12 6 16 6 18.5 10 14 14"/>
    </svg>
  ),
  Mouse: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
  ...
  Snowflake: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
      ...
      <path d="M17 5H7M17 19H7M20.66 7l-17.32 10M3.34 7l17.32 10"/>
      <path d="M3.34 7L7 9M20.66 7L17 9M3.34 17L7 15M20.66 17L17 15"/>
    </svg>
  ),
  HelpCircle: (p) => (
