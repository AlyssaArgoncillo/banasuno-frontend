...
function PhenoSection() {
  return (
    <section className="pheno-section">
      <div className="pheno-container">
        <h2 className="pheno-heading">The Urban Heat Island Effect</h2>
        <div className="pheno-box">
          <p className="pheno-description">
