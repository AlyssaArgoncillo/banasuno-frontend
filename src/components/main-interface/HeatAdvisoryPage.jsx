...
export default function HeatAdvisoryPage({ selectedZone }) {
  ...
  return (
    <div className="heat-advisory-page" style={{ padding: "clamp(16px, 4vw, 28px)", maxWidth: 860, margin: "0 auto", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: P.orange50, border: `1px solid ${P.orange100}`, borderRadius: 20, padding: "3px 12px", marginBottom: 10 }}>
          <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: P.orange700 }}>
            HEAT ADVISORY AI
          </span>
        </div>
        <h1 style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 900, fontSize: 26, color: P.gray900, margin: "0 0 6px", letterSpacing: "-0.025em" }}>
          Safety Recommendations
        </h1>
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: P.gray500, margin: 0, lineHeight: 1.6 }}>
